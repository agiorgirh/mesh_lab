...
```execute
sed "s|%USER_PROFILE_IMAGE_URI%|$USER_PROFILE_IMAGE_URI|" ./manifests/app/userprofile-deploy-v3.yaml | oc create -f -
```
...
```execute
cat ./manifests/istio/virtual-service-userprofile-90-10.yaml
```
...
```execute
oc apply -f ./manifests/istio/virtual-service-userprofile-90-10.yaml
```
...
```execute
cat ./manifests/istio/virtual-service-userprofile-50-50.yaml
```
...
```execute
oc apply -f ./manifests/istio/virtual-service-userprofile-50-50.yaml
```
...
```execute
cat ./manifests/istio/virtual-service-userprofile-v3.yaml
```
...
```execute
oc apply -f ./manifests/istio/virtual-service-userprofile-v3.yaml
```
