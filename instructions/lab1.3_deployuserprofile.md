...
```execute
cat ./manifests/app/userprofile-deploy-all.yaml | grep -B 1 sidecar.istio.io/inject
```
...
```execute
sed "s|%USER_PROFILE_IMAGE_URI%|$USER_PROFILE_IMAGE_URI|" ./manifests/app/userprofile-deploy-all.yaml | oc create -f -
```
