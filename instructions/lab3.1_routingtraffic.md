...
```execute
cat ./manifests/istio/destinationrules-all.yaml
```
...
```execute
cat ./manifests/istio/virtual-services-all-v2.yaml
```
...
```execute
oc apply -f ./manifests/istio/destinationrules-all.yaml 
oc apply -f ./manifests/istio/virtual-services-all-v2.yaml
```
...
```execute
cat ./manifests/istio/virtual-service-userprofile-v1.yaml
```
...
```execute
oc apply -f ./manifests/istio/virtual-service-userprofile-v1.yaml
```
